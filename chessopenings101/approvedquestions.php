<html>
	...
	<link rel="stylesheet" type="text/css"
		...
		<title>CO101 - Approved Questions</title>
		<style>  
		.btn2 {
				border: 1px;
				border-style: solid;
...
<?php 
        ...
        {
            $sql = "SELECT * FROM questions WHERE accepted = '1';";
			...
			<main style="width: 100%; padding-left:15%; padding-right:15%;">
                ...
                <?php
                        for($i = 0 ; $i < sizeof($arr) ; $i++)
                        {
                            ...
                            <b style=\"padding-left: 4ex;padding-right: 10ex;\">Χρήστης: ".$arr[$i][1]."</b><b style=\"padding-left: 4ex;padding-right: 10ex;\">Δυσκολία: ".$arr[$i][5]."</b><br><br>
							<button class=\"btn2\" id = \"".$arr[$i][0]."del\" onclick=\"deleteq('".$arr[$i][0]."')\"><b>Διαγραφή</b></button></div>";
                        }
                ?>
                </div>
			</main>
